...
description: "Complete guide to World Monitor features: interactive 3D globe, data layers, intelligence panels, market data, mobile UX, and keyboard shortcuts."
---
...
- **Layer System** - Toggle visibility of 56 data layers organized by category
...
- **[Country Instability Index](/country-instability-index)** — a high-frequency CII v8 stress score with signed 24-hour movement deltas, blending unrest, conflict, security, and information signals for 31 Tier-1 countries.
