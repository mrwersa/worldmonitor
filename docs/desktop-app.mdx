...
description: "Tauri desktop architecture for World Monitor — sidecar process management, secret storage, cloud fallback, and multi-platform build pipelines."
---
...
All six variants run on three platforms that work together:
